...
//
        _headlines = @[ @"Tour.Title1", @"Tour.Title2",  @"Tour.Title6", @"Tour.Title3", @"Tour.Title4", @"Tour.Title5"];
        _descriptions = @[@"Tour.Text1", @"Tour.Text2",  @"Tour.Text6", @"Tour.Text3", @"Tour.Text4", @"Tour.Text5"];
